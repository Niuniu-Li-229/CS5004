...
public class ShapeTest {
  ...
  public void setup() {
    ...
    triangle2 = new Triangle(1, 1, 5, 1, 1, 5);
  }
  ...
  public void testObjectData() {
    ...
    assertEquals("Rectangle: LL corner (2.000,3.000) width 10.000 height 10" +
        ".000",rect2
        .toString());
    assertEquals("Triangle: vertices (0.000,0.000) (4.000,0.000) (0.000,3.000)", triangle1.toString());
    assertEquals("Triangle: vertices (1.000,1.000) (5.000,1.000) (1.000,5.000)", triangle2.toString());
  }
  ...
  public void testArea() {
    ...
    assertEquals(8, triangle2.area(), 0.001);
  }
  ...
  public void testPerimeter() {
    ...
    assertEquals(4+4+Math.sqrt(32), triangle2.perimeter(),0.001);
  }
  ...
  public void testResizes() {
    ...
    resizedTri1 = triangle1.resize(4.0);
    resizedTri2 = triangle2.resize(0.25);
    ...
    assertEquals(4.0*triangle1.area(), resizedTri1.area(), 0.001);
    assertEquals(0.25*triangle2.area(), resizedTri2.area(), 0.001);
  }
